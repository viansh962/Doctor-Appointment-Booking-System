...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("sql210.infinityfree.com","if0_40920118","","if0_40920118_myhmsdb");
...
function generate_bill(){
  $con=mysqli_connect("sql210.infinityfree.com","if0_40920118","MDanas30060602","if0_40920118_myhmsdb");
  $pid = $_SESSION['pid'];
  $output='';
